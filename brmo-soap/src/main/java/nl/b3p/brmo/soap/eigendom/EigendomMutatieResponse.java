...
@XmlType(
        name = "eigendomMutatieResponse",
        propOrder = {"eigendomMutatie"})
public class EigendomMutatieResponse {
     ...
     * why there is not a {@code set} method for the eigendomMutatie property.
     *
     ...
     * </pre>
     *
     * <p>Objects of the following type(s) are allowed in the list {@link EigendomMutatie }
     */
    public List<EigendomMutatie> getEigendomMutatie() {
        if (eigendomMutatie == null) {
            eigendomMutatie = new ArrayList<>();
        }
