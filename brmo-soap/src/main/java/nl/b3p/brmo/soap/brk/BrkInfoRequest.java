...
public class BrkInfoRequest {
   ...
   * wordt de opgegeven locatie gebufferd met de genoemde bufferafstand voordat deze wordt toegepast
   * voor de selectie
   *
  ...
  /**
   * Naam waarop gezocht moet worden binnen de gerelateerde subjecten, welke als comfort informatie
   * via de BRK beschikbaar is. Er wordt minimaal gezocht op achternaam en op bedrijfsnaam.
   *
