...
public class ZakelijkeRechten {
     ...
     * why there is not a <CODE>set</CODE> method for the zakelijkRecht property.
     *
     ...
     * </pre>
     *
     * <p>Objects of the following type(s) are allowed in the list {@link ZakelijkRecht }
