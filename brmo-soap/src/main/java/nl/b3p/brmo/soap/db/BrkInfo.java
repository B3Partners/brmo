...
public class BrkInfo {
   ...
   * @throws javax.naming.NamingException als er een fout optreedt bij het opzoeken van de JNDI naam
   */
  ...
  private static StringBuilder createWhereSQL(Map<String, Object> searchContext, String dbType)
    ...
    condition =
        "   (    nat_prs.nm_geslachtsnaam like ? " + "    OR niet_nat_prs.naam like ?)"; // 2 string
    ...
    condition =
        "   (    app_re.ka_sectie like ? " + "    OR kad_perceel.ka_sectie like ?) "; // 8 string
  ...
  private static PreparedStatement addParamsSQL(
      PreparedStatement stm, Map<String, Object> searchContext, String dbType) throws SQLException {
