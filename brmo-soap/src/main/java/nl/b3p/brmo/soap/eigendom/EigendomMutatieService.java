...
public class EigendomMutatieService {
  ...
  public EigendomMutatieResponse getEigendomMutaties(
      @WebParam(name = "request") EigendomMutatieRequest request) throws EigendomMutatieException {
  ...
  public MutatieListResponse getMutatieList(@WebParam(name = "request") MutatieListRequest request)
