...
public class EigendomMutatieService {
    ...
    public EigendomMutatieResponse getEigendomMutaties(
            @WebParam(name = "request") EigendomMutatieRequest request)
            throws EigendomMutatieException {
        Map<String, Object> eigendomMutatieContext =
                EigendomInfo.createEigendomMutatieContext(request);
        return EigendomInfo.createEigendomMutatieResponse(eigendomMutatieContext);
    }

    @WebMethod(operationName = "getMutatieList")
    public MutatieListResponse getMutatieList(
            @WebParam(name = "request") MutatieListRequest request)
            throws EigendomMutatieException {
