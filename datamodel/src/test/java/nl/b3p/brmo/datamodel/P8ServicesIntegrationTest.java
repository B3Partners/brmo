 ...
 * geleuteld. We testen alleen PostgreSQL.
 *
 * <p>deze test los draaien met: {@code mvn -Dit.test=P8ServicesIntegrationTest -Dtest.onlyITs=true
 * verify -Pp8 -pl :datamodel}
 *
 * <p><strong>Door een bug in de P8 api wordt het tijdstip (GMT) van uitvragen toegevoegd aan de
 * datum begin geldigheid, daarom wordt op een aantal plaatsen de datum niet gechecked</strong>
 *
 * @author mark
 */
public class P8ServicesIntegrationTest extends P8TestFramework {
  ...
  public void testPercelen() throws IOException {
    ...
    HttpUriRequest request =
        RequestBuilder.get(params.getProperty("p8.baseurl") + "kadastralepercelen.json")
  ...
  public void testKadastraalPerceel() throws IOException {
    ...
    HttpUriRequest request =
        RequestBuilder.get(params.getProperty("p8.baseurl") + "kadastraalperceel.json")
  ...
  public void testKadastralepercelenadressen() throws IOException {
    ...
    HttpUriRequest request =
        RequestBuilder.get(params.getProperty("p8.baseurl") + "kadastralepercelenadressen.json")
            .addParameter("offset", "0")
            .addParameter("limit", "3")
            .addParameter("_format", "json")
            .build();
  ...
  public void testKadastralesubjectpercelen() throws IOException {
    ...
    HttpUriRequest request =
        RequestBuilder.get(params.getProperty("p8.baseurl") + "kadastralesubjectpercelen.json")
            .addParameter("offset", "0")
            .addParameter("limit", "3")
  ...
  public void testSubject() throws IOException {
    ...
    HttpUriRequest request =
        RequestBuilder.get(params.getProperty("p8.baseurl") + "subject.json")
            .addParameter("subjectid", "NL.KAD.Persoon.157450463")
            .addParameter("_format", "json")
            .build();
    response = client.execute(request);
  ...
  public void testSubjecten() throws IOException {
    ...
    HttpUriRequest request =
        RequestBuilder.get(params.getProperty("p8.baseurl") + "subjecten.json")
            .addParameter("offset", "0")
            .addParameter("limit", "3")
            .addParameter("_format", "json")
            .build();
    ...
    assertNotNull(body, "Response body mag niet null zijn.");
    assertJsonEquals(
        "{\"subjecten\":[{\"subjectid\":\"NL.KAD.Persoon.158819809\",\"voornamen\":\"7efe9\","
