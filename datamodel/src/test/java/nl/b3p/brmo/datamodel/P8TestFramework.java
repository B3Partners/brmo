...
public abstract class P8TestFramework {
  /**
   * properties uit {@code P8.properties} en {@code local.P8.properties}.
   *
   * @see #loadProps()
   */
  ...
  public static void setUpClass() throws IOException {
    // assumeNotNull("Verwacht P8 properties te zijn aangegeven.",
    // System.getProperty("p8.properties.file"));
    ...
    UsernamePasswordCredentials credentials =
        new UsernamePasswordCredentials(
            params.getProperty("p8.username"), params.getProperty("p8.password"));
  ...
  private static void loadProps() throws IOException {
    params.load(
        P8ServicesIntegrationTest.class.getClassLoader().getResourceAsStream("P8.properties"));
    ...
    try {
      ...
      params.load(
          P8ServicesIntegrationTest.class
              .getClassLoader()
              .getResourceAsStream("local.P8.properties"));
    } catch (IOException | NullPointerException e) {
      // negeren; het override bestand -met wachtwoorden- is normaal niet aanwezig, alleen lokaal
      // voor ontwikkelaars
