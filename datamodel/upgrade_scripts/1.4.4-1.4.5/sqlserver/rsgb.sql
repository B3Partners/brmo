-- 
-- upgrade SQLserver RSGB datamodel van 1.4.4 naar 1.4.5 
--
...
ALTER VIEW v_bd_app_re_app_re AS 
...
ALTER VIEW v_bd_kad_perceel_with_app_re AS 
...
ALTER VIEW v_bd_app_re_kad_perceel AS 
 SELECT b1.ref_id AS app_re_identif,
