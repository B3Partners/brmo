...
DELETE FROM automatisch_proces_config USING automatisch_proces WHERE automatisch_proces_config.proces_id = automatisch_proces.id
  AND automatisch_proces.dtype IN ('LaadprocesTransformatieProces', 'TopNLScannerProces');
