...
alter table ondersteunend_waterdeel add tijdstip_registratie datetime;
...
alter table ondersteunend_wegdeel add tijdstip_registratie datetime;
alter table spoor drop column datum_einde_geldh;
alter table spoor drop column bijwerkdatum;
alter table spoor add tijdstip_registratie datetime;
