...
-- brk
UPDATE kad_onrrnd_zk_archief SET datum_einde_geldh = FORMAT(CONVERT(DATETIME,datum_einde_geldh),'yyyy-MM-dd') WHERE datum_einde_geldh LIKE '[0-9][0-9]-[0-9][0-9]-[0-9][0-9][0-9][0-9]';
UPDATE kad_onrrnd_zk_aantek_archief SET eindd_aantek_kad_obj = FORMAT(CONVERT(DATETIME,eindd_aantek_kad_obj),'yyyy-MM-dd') WHERE eindd_aantek_kad_obj LIKE '[0-9][0-9]-[0-9][0-9]-[0-9][0-9][0-9][0-9]';

GO
--bag
UPDATE addresseerb_obj_aand_archief SET dat_eind_geldh = FORMAT(CONVERT(DATETIME,dat_eind_geldh),'yyyy-MM-dd') WHERE dat_eind_geldh LIKE '[0-9][0-9]-[0-9][0-9]-[0-9][0-9][0-9][0-9]';
UPDATE benoemd_terrein_archief SET datum_einde_geldh = FORMAT(CONVERT(DATETIME,datum_einde_geldh),'yyyy-MM-dd') WHERE datum_einde_geldh LIKE '[0-9][0-9]-[0-9][0-9]-[0-9][0-9][0-9][0-9]';
UPDATE gebouwd_obj_archief SET datum_einde_geldh = FORMAT(CONVERT(DATETIME,datum_einde_geldh),'yyyy-MM-dd') WHERE datum_einde_geldh LIKE '[0-9][0-9]-[0-9][0-9]-[0-9][0-9][0-9][0-9]';
UPDATE gem_openb_rmte_archief SET datum_einde_geldh = FORMAT(CONVERT(DATETIME,datum_einde_geldh),'yyyy-MM-dd') WHERE datum_einde_geldh LIKE '[0-9][0-9]-[0-9][0-9]-[0-9][0-9][0-9][0-9]';
UPDATE pand_archief SET datum_einde_geldh = FORMAT(CONVERT(DATETIME,datum_einde_geldh),'yyyy-MM-dd') WHERE datum_einde_geldh LIKE '[0-9][0-9]-[0-9][0-9]-[0-9][0-9][0-9][0-9]';
UPDATE wnplts_archief SET datum_einde_geldh = FORMAT(CONVERT(DATETIME,datum_einde_geldh),'yyyy-MM-dd') WHERE datum_einde_geldh LIKE '[0-9][0-9]-[0-9][0-9]-[0-9][0-9][0-9][0-9]';
