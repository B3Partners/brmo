...
-- Graft-De Rijp (0365) en Schermer (0458) te vervallen
   365,458,
-- Millingen aan de Rijn (0265) en Ubbergen (0282) komen te vervallen
   265,282,
-- Bernisse (0568) en Spijkenisse (0612) komen te vervallen
   568,612,
...
-- Groesbeek (0241) is hernoemt naar Berg en Dal (1945)
   241,
-- Bussum (0381), Muiden (0424) en Naarden (0425) komen te vervallen
   381,424,425,
