...
INSERT INTO gt_pk_metadata VALUES ('RSGB', 'V_P8_KADASTRAAL_ADRES', 'OID', NULL, 'assigned', NULL);
INSERT INTO gt_pk_metadata VALUES ('RSGB', 'VM_P8_KADASTRAAL_ADRES', 'OID', NULL, 'assigned', NULL);
INSERT INTO GEOMETRY_COLUMNS (F_TABLE_SCHEMA, F_TABLE_NAME, F_GEOMETRY_COLUMN, COORD_DIMENSION, SRID, TYPE) VALUES ('RSGB', 'V_P8_KADASTRAAL_ADRES', 'GEOM', 2, 28992, 'MULTIPOLYGON');
INSERT INTO GEOMETRY_COLUMNS (F_TABLE_SCHEMA, F_TABLE_NAME, F_GEOMETRY_COLUMN, COORD_DIMENSION, SRID, TYPE) VALUES ('RSGB', 'VM_P8_KADASTRAAL_ADRES', 'GEOM', 2, 28992, 'MULTIPOLYGON');
