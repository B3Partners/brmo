...
15 VALUES('VM_KAD_EIGENARENKAART', 'BEGRENZING_PERCEEL',  
16 	MDSYS.SDO_DIM_ARRAY(MDSYS.SDO_DIM_ELEMENT('X', 12000, 280000, .1),MDSYS.SDO_DIM_ELEMENT('Y', 304000, 620000, .1)), 28992); 
