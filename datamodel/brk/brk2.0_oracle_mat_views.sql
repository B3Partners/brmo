...
SELECT  qry.identificatie,
   ...
   FROM ( SELECT ri.isbelastmet AS identificatie,
           ...
           FROM recht_isbelastmet ri
             LEFT JOIN recht r ON ri.zakelijkrecht = r.identificatie
        UNION ALL
         SELECT r.identificatie,
            r.rustop AS rustop_zak_recht
           FROM recht r) qry
  WHERE qry.identificatie like 'NL.IMKAD.ZakelijkRecht:%' AND qry.rustop_zak_recht IS NOT NULL;


GRANT SELECT ON "BRMO_BRK"."VB_UTIL_ZK_RECHT_OP_KOZ" TO "BRMO_RSGB";
...
FROM (SELECT p.identificatie      AS identificatie,
      ...
      FROM BRMO_BRK.appartementsrecht a
             JOIN BRMO_BRK.recht r ON (a.identificatie = r.rustop)
             JOIN BRMO_BRK.recht r2 ON (r.isontstaanuit = r2.isbetrokkenbij)
             JOIN BRMO_BRK.perceel p ON (p.identificatie = r2.rustop)) qry
...
/*
unieke id's toevoegen in GT_PK_METADATA tabel in brk schema
INSERT INTO GT_PK_METADATA (TABLE_SCHEMA, TABLE_NAME, PK_COLUMN, PK_POLICY) VALUES ('BRMO_BRK', 'MB_SUBJECT', 'OBJECTID', 'assigned');
INSERT INTO GT_PK_METADATA (TABLE_SCHEMA, TABLE_NAME, PK_COLUMN, PK_POLICY) VALUES ('BRMO_BRK', 'MB_AVG_SUBJECT', 'OBJECTID', 'assigned');
INSERT INTO GT_PK_METADATA (TABLE_SCHEMA, TABLE_NAME, PK_COLUMN, PK_POLICY) VALUES ('BRMO_BRK', 'MB_KAD_ONRRND_ZK_ADRES', 'OBJECTID', 'assigned');
INSERT INTO GT_PK_METADATA (TABLE_SCHEMA, TABLE_NAME, PK_COLUMN, PK_POLICY) VALUES ('BRMO_BRK', 'MB_KAD_ONRRND_ZK_ARCHIEF', 'OBJECTID', 'assigned');
INSERT INTO GT_PK_METADATA (TABLE_SCHEMA, TABLE_NAME, PK_COLUMN, PK_POLICY) VALUES ('BRMO_BRK', 'MB_ZR_RECHTH', 'OBJECTID', 'assigned');
INSERT INTO GT_PK_METADATA (TABLE_SCHEMA, TABLE_NAME, PK_COLUMN, PK_POLICY) VALUES ('BRMO_BRK', 'MB_AVG_ZR_RECHTH', 'OBJECTID', 'assigned');
INSERT INTO GT_PK_METADATA (TABLE_SCHEMA, TABLE_NAME, PK_COLUMN, PK_POLICY) VALUES ('BRMO_BRK', 'MB_KOZ_RECHTH', 'OBJECTID', 'assigned');
INSERT INTO GT_PK_METADATA (TABLE_SCHEMA, TABLE_NAME, PK_COLUMN, PK_POLICY) VALUES ('BRMO_BRK', 'MB_AVG_KOZ_RECHTH', 'OBJECTID', 'assigned');
*/

/*
unieke id's toevoegenin GT_PK_METADATAtabel in public schema
INSERT INTO GT_PK_METADATA (TABLE_SCHEMA, TABLE_NAME, PK_COLUMN, PK_POLICY) VALUES ('BRMO_RSGB', 'MB_KADASTRALEONROERENDEZAKENMETADRES', 'OBJECTID', 'assigned');
INSERT INTO GT_PK_METADATA (TABLE_SCHEMA, TABLE_NAME, PK_COLUMN, PK_POLICY) VALUES ('BRMO_RSGB', 'MB_ONROERENDEZAKENMETRECHTHEBBENDEN', 'OBJECTID', 'assigned');
INSERT INTO GT_PK_METADATA (TABLE_SCHEMA, TABLE_NAME, PK_COLUMN, PK_POLICY) VALUES ('BRMO_RSGB', 'MB_AVG_ONROERENDEZAKENMETRECHTHEBBENDEN', 'OBJECTID', 'assigned');
*/
