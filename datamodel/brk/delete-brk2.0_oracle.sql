...
DROP TABLE aantekeningrecht CASCADE CONSTRAINTS PURGE;
DROP TABLE isbelastmet CASCADE CONSTRAINTS PURGE;
DROP TABLE isbeperkttot CASCADE CONSTRAINTS PURGE;
