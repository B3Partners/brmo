...
AS
 SELECT row_number() OVER () AS objectid,
    ...
    qry.type,
    (COALESCE(o.sectie, '') || ' ') || COALESCE(o.perceelnummer, '') AS aanduiding,
    (((((COALESCE(o.akrkadastralegemeente, '') || ' ') || COALESCE(o.sectie, '')) || ' ') || COALESCE(o.perceelnummer, '')) || ' ') || COALESCE(o.appartementsrechtvolgnummer, '') AS aanduiding2,
    o.sectie,
    o.perceelnummer,
    ...
    o.koopsom_valuta,
    NULL AS loc_omschr,
    array_to_string(( SELECT array_agg(((((((((((((((((((('id: ' || r.identificatie) || ', ') || 'aard: ') || COALESCE(r.aard, '')) || ', ') || 'begin: ') || COALESCE(r.begingeldigheid, '')) || ', ') || 'beschrijving: ') || COALESCE(r.omschrijving, '')) || ', ') || 'eind: ') || COALESCE(r.einddatum, '')) || ', ') || 'koz-id: ') || COALESCE(r.aantekeningkadastraalobject, '')) || ', ') || 'subject-id: ') || COALESCE(r.betrokkenpersoon, '')) || '; ') AS array_agg
           FROM brk.recht r
...
CREATE MATERIALIZED VIEW IF NOT EXISTS public.mb_onroerendezakenmetrechthebbenden
TABLESPACE pg_default
AS SELECT row_number() OVER () AS objectid,
    ...
    koz.type,
    rtrim(koz.aanduiding),
    rtrim(koz.aanduiding2(),
    koz.sectie,
    koz.perceelnummer,
