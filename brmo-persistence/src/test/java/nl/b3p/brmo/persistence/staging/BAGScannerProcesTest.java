...
public class BAGScannerProcesTest extends TestUtil {
  ...
  public void roundtrip() {
    ...
    assertEquals(
        DIR, c.getScanDirectory(), "Verwacht dat de scan directory is zoals geconfigureerd.");
    assertEquals(
        DIR, c.getArchiefDirectory(), "Verwacht dat de archief directory is zoals geconfigureerd.");
    assertEquals(
        "true",
