...
# sqlplus -l -S jenkins_rsgb/jenkins_rsgb@192.168.1.11:1521/ORCL <<< "update GEOMETRY_COLUMNS set F_TABLE_SCHEMA = 'JENKINS_RSGB';"
# sqlplus -l -S jenkins_rsgb/jenkins_rsgb@192.168.1.11:1521/ORCL <<< "update GT_PK_METADATA set TABLE_SCHEMA = 'JENKINS_RSGB';"
