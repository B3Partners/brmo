  ...
  public static class BAGExtractSelectieFromLeveringsdocument implements BAGExtractSelectie {
    ...
    public LocalDate getMutatiesFrom() {
      XMLGregorianCalendar xmlGregorianCalendar =
          levering.getSelectieGegevens().getMUTExtract().getMutatieperiode().getMutatiedatumVanaf();
      return LocalDate.of(
    ...
    public LocalDate getMutatiesTot() {
      XMLGregorianCalendar xmlGregorianCalendar =
          levering.getSelectieGegevens().getMUTExtract().getMutatieperiode().getMutatiedatumTot();
      return LocalDate.of(
          xmlGregorianCalendar.getYear(),
          xmlGregorianCalendar.getMonth(),
          xmlGregorianCalendar.getDay());
