 ...
 * testcase voor laden van nevenvestigingen. <br>
...
public class GH522NhrToStagingToRsgbIntegrationTest extends AbstractDatabaseIntegrationTest {
  ...
  static Stream<Arguments> argumentsProvider() {
    return Stream.of(
        ...
        arguments(
            "/nhr-v3/2020-04-30-120558-31035585.anon.xml",
            MapUtils.putAll(
                ...
                new Object[][] {
                  ...
                  {"functionaris", 1 + 7},
                  {
                    "select * from subject where identif='nhr.comVestg.000017320496' and pa_postadres_postcode='3927ZL' and pa_postadrestype='P' and pa_postbus__of_antwoordnummer='34'",
                    1
                  },
                  {
                    "select * from subject where identif='nhr.comVestg.000019946252' and fk_15aoa_identif='0482010001255998'",
                    1
                  },
                })),
        // #2 HEMA B.V.
        arguments(
            "/nhr-v3/2020-04-30-121846-34215639.anon.xml",
            MapUtils.putAll(
                new HashMap<String, Integer>(),
                new Object[][] {
                  {"vestg", 281},
        ...
        arguments(
            "/nhr-v3/2020-04-30-121909-39082874.anon.xml",
            MapUtils.putAll(
                new HashMap<String, Integer>(),
                new Object[][] {
                  {"vestg", 87},
                  {
                    "select * from subject where identif='nhr.comVestg.000016834623' and fk_15aoa_identif='0034010000049149'",
                    1
                  },
                  {
                    "select * from subject where identif='nhr.comVestg.000016833503' and fk_15aoa_identif='0758010000023411'",
                    1
                  },
                })),
        // #4 FrieslandCampina Nederland B.V.
        arguments(
            "/nhr-v3/2020-04-30-121929-01070163.anon.xml",
            MapUtils.putAll(
                new HashMap<String, Integer>(),
                new Object[][] {
                  {"vestg", 37},
                  {
                    "select * from subject where identif='nhr.comVestg.000019021232' and pa_postadres_postcode='1850AB' and pa_postadrestype='P' and pa_postbus__of_antwoordnummer='53'",
                    1
                  },
                })),
        // #5 Prysmian Netherlands B.V.
        arguments(
            "/nhr-v3/2020-04-30-121952-58087850.anon.xml",
            MapUtils.putAll(
                new HashMap<String, Integer>(),
                new Object[][] {
                  {"vestg", 3},
  ...
  public void testNhrXMLToStagingToRsgb(String bestandNaam, Map<String, Integer> rowCounts)
    ...
    assumeFalse(
        null == GH522NhrToStagingToRsgbIntegrationTest.class.getResource(bestandNaam),
        "Het test bestand moet er zijn.");

    brmo.loadFromFile(
        "nhr",
        GH522NhrToStagingToRsgbIntegrationTest.class.getResource(bestandNaam).getFile(),
        null);
