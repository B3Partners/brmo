...
/**
 * Draaien met: {@code mvn -Dit.test=Brk2MutatieVerwijderVerwerkingIntegrationTest
 * -Dtest.onlyITs=true verify -Ppostgresql -pl brmo-loader > /tmp/postgresql.log} of {@code mvn
 * -Dit.test=Brk2MutatieVerwijderVerwerkingIntegrationTest -Dtest.onlyITs=true verify -Poracle -pl
...
class Brk2MutatieVerwijderVerwerkingIntegrationTest extends AbstractDatabaseIntegrationTest {
    ...
    private static final Log LOG =
            LogFactory.getLog(Brk2MutatieVerwijderVerwerkingIntegrationTest.class);
    ...
    static Stream<Arguments> argumentsProvider() {
        return Stream.of(
                ...
                arguments(
                        ...
                        // 1e bericht
                        Set.of(
                                "NL.IMKAD.ZakelijkRecht:1001274173",
                                "NL.IMKAD.Tenaamstelling:1007585455"),
                        Set.of(
                                "NL.IMKAD.TIAStuk:20040115000632",
                                "NL.IMKAD.TIAStuk:20090402001713"),
                        ...
                        new FileInputStream(
                                new File(
                                        Objects.requireNonNull(
                                                        Brk2MutatieVerwijderVerwerkingIntegrationTest
                                                                .class
                                                                .getResource(
    ...
    void testBericht(
        ...
        assumeFalse(
                null
                        == Brk2MutatieVerwijderVerwerkingIntegrationTest.class.getResource(
                                bestandNaam),
        ...
        checkIdentificatiesEnAantal(
                perceelOfAppRe, Collections.emptySet(), mutatieBestandNamen.length);
        checkIdentificatiesEnAantal(
     ...
     * @throws Exception if any
     */
    private void bestandLadenEnValideren(
            String objectRef, int eerderGeladen, String... bestandsNamen) throws Exception {
