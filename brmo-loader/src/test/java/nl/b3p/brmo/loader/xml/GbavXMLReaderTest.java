...
public class GbavXMLReaderTest {
    ...
    public void berichtTest() throws Exception {
        ...
        GbavBericht b;
        assumeFalse(
                null == GbavXMLReaderTest.class.getResourceAsStream("gbav-voorbeeld.xml"),
                "testdata moet aanwezig zijn");
        ...
        while (r.hasNext()) {
            ...
            LOG.debug(
                    String.format(
                            "Bericht #%d van %tF %2$tT, object ref %s",
                            b.getVolgordeNummer(), b.getDatum(), b.getObjectRef()));
            total++;
            ...
            assertEquals(
                    new SimpleDateFormat("yyyy-MM-dd").parse("2018-02-01"),
                    b.getDatum(),
        ...
        assertArrayEquals(
                new String[] {
                    GbavXMLReader.PREFIX + "b3e513383d0454de798b29c6900643130e3b2d6b",
                },
    ...
    public void meerderePersonenTest() throws Exception {
        ...
        assumeFalse(
                null == GbavXMLReaderTest.class.getResourceAsStream("persoonslijst.xml"),
                "testdata moet aanwezig zijn");
        ...
        while (r.hasNext()) {
            ...
            assertEquals(BrmoFramework.BR_GBAV, b.getSoort(), "Soort komt niet overeen");
            assertEquals(
                    total, b.getVolgordeNummer().intValue(), "Volgordenummer komt niet overeen");
            total++;
        }
