...
public class BagBerichtIntegrationTest extends AbstractDatabaseIntegrationTest {
  ...
  public void setUp() throws Exception {
    ...
    assumeTrue(0L == brmo.getCountBerichten(BR_BAG, "STAGING_OK"), "Er zijn STAGING_OK berichten");
    assumeTrue(
        0L == brmo.getCountLaadProcessen(BR_BAG, "STAGING_OK"), "Er zijn STAGING_OK laadprocessen");
  }
  ...
  public void loadAll() throws Exception {
    ...
    while (i.hasNext()) {
      ...
      brmo.loadFromFile(
          BR_BAG, BagBerichtIntegrationTest.class.getResource(data[0].toString()).getFile(), null);
    ...
    assertEquals(
        "VA1071182", brondocument.getValue(0, "identificatie"), "brondocumentnummer klopt niet");
