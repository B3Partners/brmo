...
public class Art37aIntegrationTest extends AbstractDatabaseIntegrationTest {
  ...
  public void testAfgeschermdBericht()
    ...
    brmo.loadFromFile(
        BrmoFramework.BR_BRK, Art37aIntegrationTest.class.getResource(bestandNaam).getFile(), null);
    ...
    final List<String> kadaster_indentifs =
        Arrays.asList("NL.KAD.Tenaamstelling.1000020370", "NL.KAD.ZakelijkRecht.AKR1.1447782");
