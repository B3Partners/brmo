...
class Brk2StandMutatieGedeeldeStukkenVerwerkingIntegrationTest
  ...
  static Stream<Arguments> argumentsProvider() {
    return Stream.of(
        ...
        arguments(
            new String[] {
              "/brk2/stand-53880252670000.anon.xml", "/brk2/stand-53880252170000.anon.xml"
            },
            new String[] {
              "/brk2/mutatie-53880252670000-1.anon.xml", "/brk2/mutatie-53880252170000-1.anon.xml"
            },
            Set.of(
  ...
  void testBerichten(
    ...
    assumeFalse(
        null
            == Brk2StandMutatieGedeeldeStukkenVerwerkingIntegrationTest.class.getResource(
                bestandNamen[0]),
   ...
   */
  private void checkIdentificatiesEnAantal(ITable tableToCheck, Set<String> expectedIdentificaties)
      throws Exception {
    assertEquals(
