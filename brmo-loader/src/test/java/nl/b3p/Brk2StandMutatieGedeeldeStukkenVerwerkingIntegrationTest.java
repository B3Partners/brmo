...
/**
 * Testcases voor 1 of meer objecten uit stand en per object 1 mutatie. Draaien met: {@code mvn
 * -Dit.test=Brk2StandMutatieGedeeldeStukkenVerwerkingIntegrationTest -Dtest.onlyITs=true verify
 * -Ppostgresql -pl brmo-loader > /tmp/postgresql.log} of {@code mvn
 * -Dit.test=Brk2StandMutatieGedeeldeStukkenVerwerkingIntegrationTest -Dtest.onlyITs=true verify
 * -Poracle -pl brmo-loader > /tmp/oracle.log} voor Oracle.
 *
 * @author mprins
...
class Brk2StandMutatieGedeeldeStukkenVerwerkingIntegrationTest
    ...
    private static final Log LOG =
            LogFactory.getLog(Brk2StandMutatieGedeeldeStukkenVerwerkingIntegrationTest.class);
    ...
    static Stream<Arguments> argumentsProvider() {
        return Stream.of(
                ...
                // stukkenMutaties,
                // stukdelenMutaties,
                // int aantalKadObjLocatie, int aantalPubliekRBeperking, int aantalOnrndZkBeperking,
                // int aantalFiliatie
                arguments(
                        new String[] {
                            "/brk2/stand-53880252670000.anon.xml",
                            "/brk2/stand-53880252170000.anon.xml"
                        },
                        new String[] {
                            "/brk2/mutatie-53880252670000-1.anon.xml",
                            "/brk2/mutatie-53880252170000-1.anon.xml"
                        },
                        Set.of(
                                "NL.IMKAD.KadastraalObject:53880252670000",
                                "NL.IMKAD.KadastraalObject:53880252170000"),
                        Set.of(
                                "NL.IMKAD.ZakelijkRecht:50036403",
                                "NL.IMKAD.Tenaamstelling:50111282", /*2e*/
                                "NL.IMKAD.ZakelijkRecht:50036398",
                                "NL.IMKAD.Tenaamstelling:50111273",
                                "NL.IMKAD.Aantekening:50007474"),
                        // stukken NL.IMKAD.TIAStuk:20020924000346 en
                        // NL.IMKAD.TIAStuk:20081017002053 worden gedeeld in de stand
                        Stream.of(
                                        "NL.IMKAD.TIAStuk:20020924000346",
                                        "NL.IMKAD.TIAStuk:20081017002053", /*2e*/
                                        "NL.IMKAD.TIAStuk:18011026015603",
                                        "NL.IMKAD.TIAStuk:20020924000346",
                                        "NL.IMKAD.TIAStuk:20081017002053")
                        ...
                        Stream.of(
                                        "NL.IMKAD.Stukdeel:1022805638",
                                        "NL.IMKAD.Stukdeel:AKR1.10630844", /*2e*/
                                        "NL.IMKAD.TIAStuk:20081017002053",
                                        "NL.IMKAD.Stukdeel:AKR1.10630844",
                                        "NL.IMKAD.Stukdeel:AKR1.10754757")
                                .collect(Collectors.toCollection(HashSet::new)),
                        // mutaties
                        Stream.of(
                                        "NL.IMKAD.ZakelijkRecht:50036403",
                                        "NL.IMKAD.Tenaamstelling:1013515840",
                                        "NL.IMKAD.Tenaamstelling:1013515841", /*2*/
                                        "NL.IMKAD.ZakelijkRecht:50036398",
                                        "NL.IMKAD.Tenaamstelling:1013515838",
                                        "NL.IMKAD.Tenaamstelling:1013515839",
                                        "NL.IMKAD.Aantekening:50007474")
                                .collect(Collectors.toCollection(HashSet::new)),
                        Stream.of(
                                        "NL.IMKAD.TIAStuk:20221117001513", /*2e*/
                                        "NL.IMKAD.TIAStuk:18011026015603",
                                        "NL.IMKAD.TIAStuk:20221117001513")
                                .collect(Collectors.toCollection(HashSet::new)),
                        Stream.of(
                                        "NL.IMKAD.Stukdeel:500006680324", /*2e*/
                                        "NL.IMKAD.Stukdeel:500006680324",
                                        "NL.IMKAD.Stukdeel:AKR1.10754757")
                                .collect(Collectors.toCollection(HashSet::new)),
                        2,
                        0,
        ...
        if (this.isOracle) {
            ...
            rsgbBrk =
                    new DatabaseDataSourceConnection(
                            dsRsgbBrk, params.getProperty("rsgbbrk.schema"));
            rsgbBrk.getConfig()
                    .setProperty(
                            DatabaseConfig.PROPERTY_DATATYPE_FACTORY,
                            new PostgresqlDataTypeFactory());
    ...
    void testBerichten(
        ...
        assumeFalse(
                null
                        == Brk2StandMutatieGedeeldeStukkenVerwerkingIntegrationTest.class
                                .getResource(bestandNamen[0]),
        ...
        ITable onroerendezaakbeperking =
                rsgbBrk.createDataSet().getTable("onroerendezaakbeperking");
        ...
        for (int i = 0; i < onroerendezaakfiliatie.getRowCount(); i++) {
            ...
            assertTrue(
                    ...
                    "onroerendezaakfiliatie.onroerendezaak "
                            + onroerendezaakRef
                            + " is niet gelijk aan objectRef");
        }
        for (int i = 0; i < onroerendezaakfiliatie_archief.getRowCount(); i++) {
            onroerendezaakRef =
                    onroerendezaakfiliatie_archief.getValue(i, "onroerendezaak").toString();
            assertTrue(
                    objectRefs.contains(onroerendezaakRef),
        ...
        assertAll(
                ...
                () -> {
                    ...
                    for (int i = 0; i < objectlocatie.getRowCount(); i++) {
                        assertTrue(
                                objectRefs.contains(objectlocatie.getValue(i, "heeft")),
                ...
                () -> {
                    for (int i = 0; i < objectlocatie_archief.getRowCount(); i++) {
                        assertTrue(
                                objectRefs.contains(objectlocatie_archief.getValue(i, "heeft")),
                                "objectlocatie.heeft is niet gelijk aan objectRef");
                    }
                });
    }
    ...
    private void checkIdentificatiesEnAantal(
            ITable tableToCheck, Set<String> expectedIdentificaties) throws Exception {
        assertEquals(
                expectedIdentificaties.size(),
    ...
    private void transformerenEnValideren(int expected) throws BrmoException, InterruptedException {
        LOG.info(
                "Transformeren berichten naar rsgb DB met optie 'orderberichten': "
                        + brmo.isOrderBerichten());
     ...
     * @throws Exception if any
     */
    private void bestandenLadenEnValideren(
            Set<String> objectRefs, int eerderGeladen, String... bestandsNamen) throws Exception {
