...
public class BedrijfAlsFuntionarisNhrToStagingToRsgbIntegrationTest
  ...
  public void setUp() throws Exception {
    ...
    assumeTrue(
        0L == brmo.getCountBerichten("nhr", "STAGING_OK"), "Er zijn geen STAGING_OK berichten");
    assumeTrue(
  ...
  public void testNhrXMLToStagingToRsgb(String bestandNaam, Map<String, Integer> rowCounts)
    ...
    assertEquals(1, bericht.getRowCount(), "Er zijn meer of minder dan 1 rij");
    assertNotNull(
        bericht.getValue(0, "br_orgineel_xml"), "BR origineel xml is null na transformatie");
    assertEquals(
        berichtId,
