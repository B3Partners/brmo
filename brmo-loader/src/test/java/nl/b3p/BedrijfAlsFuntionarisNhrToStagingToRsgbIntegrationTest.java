 ...
 * voor bedrijven met bedrijf als functionaris. <br>
 * Draaien met: {@code mvn -Dit.test=BedrijfAlsFuntionarisNhrToStagingToRsgbIntegrationTest
...
public class BedrijfAlsFuntionarisNhrToStagingToRsgbIntegrationTest
    ...
    private static final Log LOG =
            LogFactory.getLog(BedrijfAlsFuntionarisNhrToStagingToRsgbIntegrationTest.class);
    ...
    static Stream<Arguments> argumentsProvider() {
        return Stream.of(
                ...
                arguments(
                        "/nhr-v3/bedrijf-als-functionaris/2020-06-18-153436-01037917.anon.xml",
                        MapUtils.putAll(
                                ...
                                new Object[][] {
                                    ...
                                    {
                                        "select sc_identif as hoofdvestiging from vestg where fk_19mac_kvk_nummer is not null",
                                        1
                                    },
                                    {
                                        "select sc_identif as hoofdvestiging from vestg where hoofdvestiging = 'Ja'",
                                        1
                                    },
                                    {
                                        "select sc_identif as hoofdvestiging from vestg where hoofdvestiging = 'Nee'",
                                        1
                                    },
                                    {"functionaris", 5},
                                    {
                                        "select * from functionaris where fk_sc_lh_pes_sc_identif='nhr.buitenlVenn.naam.782f4c4bef5a6bf48206ed2c6c6b9fbe138af4a7' and functie='Enig aandeelhouder'",
                                        1
                                    },
                                    {
                                        "select * from subject where identif='nhr.buitenlVenn.naam.782f4c4bef5a6bf48206ed2c6c6b9fbe138af4a7'",
                                        1
                                    },
                                    {"ander_btnlnds_niet_nat_prs", 1},
                                    {
                                        "select kvk_nummer from maatschapp_activiteit where nonmailing = 'Nee'",
                                        1
                                    },
                                })),
                // #2 BVNN/Boskalis Dolman V.O.F. / 01083730 / 2 samenwerkingsverbanden als
                // functionaris
                arguments(
                        "/nhr-v3/bedrijf-als-functionaris/2020-06-18-154135-01083730.anon.xml",
                        MapUtils.putAll(
                                new HashMap<String, Integer>(),
                                new Object[][] {
                                    {"maatschapp_activiteit", 1},
                ...
                arguments(
                        "/nhr-v3/bedrijf-als-functionaris/2020-06-18-154143-01173390.anon.xml",
                        MapUtils.putAll(
                                new HashMap<String, Integer>(),
                                new Object[][] {
                                    {"maatschapp_activiteit", 1},
                ...
                // #4 Tiktak/Segafredo Zanetti Nederland B.V. / 4 nat. personen als functionaris,
                // met een aantal buitenlandse pers. en een buitenlandseVennootschap
                arguments(
                        "/nhr-v3/bedrijf-als-functionaris/2020-06-18-154147-02000099.anon.xml",
                        MapUtils.putAll(
                                new HashMap<String, Integer>(),
                                new Object[][] {
                                    {"maatschapp_activiteit", 1},
                ...
                // #5 Visser Transport B.V. / heeft een buitenlandseVennootschap als functionaris
                // met een ampersand in de naam..
                arguments(
                        "/nhr-v3/bedrijf-als-functionaris/2020-06-18-154151-02014331.anon.xml",
                        MapUtils.putAll(
                                new HashMap<String, Integer>(),
                                new Object[][] {
                                    {"maatschapp_activiteit", 1},
                ...
                // #6 Etex Building Performance B.V. / heeft een buitenlandseVennootschap als
                // functionaris + een aantal andere personen
                arguments(
                        "/nhr-v3/bedrijf-als-functionaris/2020-06-18-154155-02320379.anon.xml",
                        MapUtils.putAll(
                                new HashMap<String, Integer>(),
                                new Object[][] {
                                    {"maatschapp_activiteit", 1},
                ...
                // #7
                arguments(
                        "/nhr-v3/bedrijf-als-functionaris/2020-06-18-154200-02328563.anon.xml",
                        MapUtils.putAll(
                                new HashMap<String, Integer>(),
                                new Object[][] {
                                    {"maatschapp_activiteit", 1},
                                    ...
                                    {
                                        "select kvk_nummer from maatschapp_activiteit where nonmailing = 'Ja'",
                                        1
                                    },
                                })),
                // #8 Handelsonderneming Koen Meijer B.V. /
                arguments(
                        "/nhr-v3/bedrijf-als-functionaris/2020-06-18-154203-02334440.anon.xml",
                        MapUtils.putAll(
                                new HashMap<String, Integer>(),
                                new Object[][] {
                                    {"maatschapp_activiteit", 1},
                ...
                // #9 Aareon Nederland B.V. / buitenlandseVennootschap en natuurlijke personen als
                // functionaris
                arguments(
                        "/nhr-v3/bedrijf-als-functionaris/2020-06-18-154209-04026125.anon.xml",
                        MapUtils.putAll(
                                new HashMap<String, Integer>(),
                                new Object[][] {
                                    {"maatschapp_activiteit", 1},
                ...
                // #10
                arguments(
                        "/nhr-v3/bedrijf-als-functionaris/2020-06-18-154213-04033993.anon.xml",
                        MapUtils.putAll(
                                new HashMap<String, Integer>(),
                                new Object[][] {
                                    {"maatschapp_activiteit", 1},
                ...
                arguments(
                        "/nhr-v3/bedrijf-als-functionaris/2020-06-18-154218-04040443.anon.xml",
                        MapUtils.putAll(
                                new HashMap<String, Integer>(),
                                new Object[][] {
                                    {"maatschapp_activiteit", 1},
                ...
                arguments(
                        "/nhr-v3/bedrijf-als-functionaris/2020-06-18-154222-04058882.anon.xml",
                        MapUtils.putAll(
                                new HashMap<String, Integer>(),
                                new Object[][] {
                                    {"maatschapp_activiteit", 1},
                ...
                arguments(
                        "/nhr-v3/bedrijf-als-functionaris/2020-06-18-154225-08059166.anon.xml",
                        MapUtils.putAll(
                                new HashMap<String, Integer>(),
                                new Object[][] {
                                    {"maatschapp_activiteit", 1},
                ...
                arguments(
                        "/nhr-v3/bedrijf-als-functionaris/2020-06-18-154229-09006404.anon.xml",
                        MapUtils.putAll(
                                new HashMap<String, Integer>(),
                                new Object[][] {
                                    {"maatschapp_activiteit", 1},
                ...
                arguments(
                        "/nhr-v3/bedrijf-als-functionaris/2020-06-18-154232-09013687.anon.xml",
                        MapUtils.putAll(
                                new HashMap<String, Integer>(),
                                new Object[][] {
                                    {"maatschapp_activiteit", 1},
                ...
                // #16 Eismann B.V.
                arguments(
                        "/nhr-v3/bedrijf-als-functionaris/2020-06-18-154235-09049151.anon.xml",
                        MapUtils.putAll(
                                new HashMap<String, Integer>(),
                                new Object[][] {
                                    {"maatschapp_activiteit", 1},
                ...
                arguments(
                        "/nhr-v3/bedrijf-als-functionaris/2020-06-18-154239-09107097.anon.xml",
                        MapUtils.putAll(
                                new HashMap<String, Integer>(),
                                new Object[][] {
                                    {"maatschapp_activiteit", 1},
                ...
                arguments(
                        "/nhr-v3/bedrijf-als-functionaris/2020-06-18-154242-09118128.anon.xml",
                        MapUtils.putAll(
                                new HashMap<String, Integer>(),
                                new Object[][] {
                                    {"maatschapp_activiteit", 1},
                ...
                arguments(
                        "/nhr-v3/bedrijf-als-functionaris/2020-06-18-154245-09131564.anon.xml",
                        MapUtils.putAll(
                                new HashMap<String, Integer>(),
                                new Object[][] {
                                    {"maatschapp_activiteit", 1},
                                    {"vestg", 3},
                                    // "Melspring-Farmershouse" en "Melspring international" hebben
                                    // hetzelfde vestigingsnummer
                                    {"vestg_naam", 4},
                                    {"ander_btnlnds_niet_nat_prs", 1},
                                    // er zitten subjecten in met >1 functionaris rol
                                    {"functionaris", 5},
    ...
    public void testNhrXMLToStagingToRsgb(String bestandNaam, Map<String, Integer> rowCounts)
            throws Exception {

        assumeFalse(
                null
                        == BedrijfAlsFuntionarisNhrToStagingToRsgbIntegrationTest.class.getResource(
                                bestandNaam),
                "Het test bestand moet er zijn.");

        brmo.loadFromFile(
                "nhr",
                BedrijfAlsFuntionarisNhrToStagingToRsgbIntegrationTest.class
        ...
        bericht =
                staging.createQueryTable(
                        "bericht", "select * from bericht where object_ref like 'nhr.%Vestg%'");
        assertEquals(
                rowCounts.get("vestg"),
                Integer.valueOf(bericht.getRowCount()),
                "aantal (niet)commerciele vestiging berichten onjuist");
