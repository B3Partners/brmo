...
class Brk2ToStagingToRsgbBrkIntegrationTest extends AbstractDatabaseIntegrationTest {
                        ...
                        new FileInputStream(
                                new File(
                                        Objects.requireNonNull(
                                                        Brk2ToStagingToRsgbBrkIntegrationTest.class
                                                                .getResource(
    ...
    void testBericht(
        ...
        assertAll(
                ...
                () ->
                        assertEquals(
                                aantalRecht,
                                recht.getRowCount(),
                                "Er is geen/teveel/te weinig recht"),
                () ->
                        assertEquals(
        ...
        assertEquals(
                aantalStukdeel,
                stukdeel.getRowCount(),
                "Het aantal stukdeel is niet als verwacht.");

        ITable persoon = rsgbBrk.createDataSet().getTable("persoon");
        assertEquals(
                aantalNP + aantalNNP,
                persoon.getRowCount(),
                "Het aantal persoon is niet als verwacht.");

        ITable natuurlijkpersoon = rsgbBrk.createDataSet().getTable("natuurlijkpersoon");
        assertEquals(
                aantalNP,
                natuurlijkpersoon.getRowCount(),
                "Het aantal nat.persoon is niet als verwacht.");
