  ...
  static Stream<Arguments> argumentsProvider() {
    return Stream.of(
        ...
        arguments(
            ...
            1 + 7,
            52813150,
            new String[] {"8411", "8411", "8411", "8411", "8411", "8411", "8411", "8411"},
            0),
        /* #9 sbb*/
        arguments(
            "/nhr-v3/30263544.anon.xml",
            1 /*rechtspers*/ + 1 /*maatsch act.*/ + 1 /*hfd vestg*/ + 13 /*neven vestg*/,
            1,
            2,
            3 + 13 /*subj*/,
            2,
        ...
        arguments(
            ...
            new String[] {
              ...
              "8010", "4652", "85592", "6202", "4321", "8010", "4652", "85592", "6202", "4321",
              "8010", "4652", "85592", "6202", "4321", "8010", "85592", "4652", "6202", "4321",
              "8010", "4652", "85592", "6202", "4321", "8010", "4652", "85592", "6202", "4321",
  ...
  public void testNhrXMLToStagingToRsgb(
    ...
    for (int i = 0; i < subject.getRowCount(); i++) {
      if (subject.getValue(i, "identif").toString().contains("nhr.maatschAct.kvk")) {
        assertEquals(
            kvkNummer + "", subject.getValue(i, "kvk_nummer") + "", "KVK nummer klopt niet");
        foundKvk = true;
      }
    }
    if (!foundKvk) {
    ...
    if (kvkNummer == 41177576) {
      ...
      functionaris =
          rsgb.createQueryTable("functionaris", "select * from functionaris order by functie ASC");
      assertEquals("Gevolmachtigde", functionaris.getValue(aantalFunctionarissen - 1, "functie"));
      assertEquals(
          "Directeur", functionaris.getValue(aantalFunctionarissen - 1, "functionaristypering"));
      assertEquals(
          "B", functionaris.getValue(aantalFunctionarissen - 1, "volledig_beperkt_volmacht"));
    }
  }
}
