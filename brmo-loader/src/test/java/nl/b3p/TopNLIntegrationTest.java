...
public class TopNLIntegrationTest extends AbstractDatabaseIntegrationTest {
  ...
  static Stream<Arguments> argumentsProvider() {
    return Stream.of(
        ...
        arguments(
            TopNLType.TOP50NL, "/topnl/top50nl_spoorbaandeel.gml", 0, 1, "top50nl spoorbaandeel"),
        ...
        // leeg bestand
        arguments(
            TopNLType.TOP10NL, "/topnl/top10nl_plantopografie.gml", 0, 1, "top10nl plantopografie"),
        arguments(
            TopNLType.TOP10NL,
        ...
        arguments(
            TopNLType.TOP10NL, "/topnl/top10nl_spoorbaandeel.gml", 0, 1, "top10nl spoorbaandeel"),
  ...
  public void setUp() throws Exception {
    ...
    IDataSet stagingDataSet =
        fxdb.build(
            new FileInputStream(
                new File(
                    TopNLIntegrationTest.class.getResource("/staging-empty-flat.xml").toURI())));

    sequential.lock();

    DatabaseOperation.CLEAN_INSERT.execute(staging, stagingDataSet);

    assumeTrue(0L == brmo.getCountBerichten(null, "STAGING_OK"), "Er zijn STAGING_OK berichten");
    assumeTrue(
        0L == brmo.getCountLaadProcessen(null, "STAGING_OK"), "Er zijn STAGING_OK laadprocessen");
  }
  ...
  public void loadTopNLInStaging(
    ...
    // assumeNotNull
    assertNotNull(
        TopNLIntegrationTest.class.getResource(bestandNaam), "Het test bestand moet er zijn.");

    brmo.loadFromFile(
        bestandType.getType(), TopNLIntegrationTest.class.getResource(bestandNaam).getFile(), null);
  ...
  public void processTopNL(
    ...
    for (TopNLType type : TopNLType.values()) {
      ids.addAll(
          Arrays.asList(
              brmo.getLaadProcessenIds("bestand_datum", "ASC", type.getType(), "STAGING_OK")));
    }
