...
/**
 * Draaien met: {@code mvn -Dit.test=TopNLIntegrationTest -Dtest.onlyITs=true verify -Ppostgresql
 * -pl brmo-loader > /tmp/postgresql.log} voor bijvoorbeeld PostgreSQL of {@code mvn
 * -Dit.test=TopNLIntegrationTest -Dtest.onlyITs=true verify -Poracle > target/oracle.log} voor
 * Oracle.
 *
 * @author Mark Prins
 */
public class TopNLIntegrationTest extends AbstractDatabaseIntegrationTest {
    ...
    static Stream<Arguments> argumentsProvider() {
        return Stream.of(
                ...
                arguments(
                        TopNLType.TOP250NL,
                        "/topnl/top250nl_functioneelgebied.gml",
                        0,
                        1,
                        "top250nl functioneelgebied"),
                arguments(
                        TopNLType.TOP250NL, "/topnl/top250nl_gebouw.gml", 0, 1, "top250nl gebouw"),
                arguments(
                        TopNLType.TOP250NL,
                        "/topnl/top250nl_geografischgebied.gml",
                        0,
                        1,
                        "top250nl geografischgebied"),
                arguments(
                        TopNLType.TOP250NL, "/topnl/top250nl_hoogte.gml", 0, 1, "top250nl hoogte"),
                arguments(
                        TopNLType.TOP250NL,
                        "/topnl/top250nl_inrichtingselement.gml",
                        0,
                        1,
                        "top250nl inrichtingselement"),
                arguments(
                        TopNLType.TOP250NL, "/topnl/top250nl_plaats.gml", 0, 1, "top250nl plaats"),
                arguments(
                        TopNLType.TOP250NL,
                        "/topnl/top250nl_registratiefgebied.gml",
                        0,
                        1,
                        "top250nl registratiefgebied"),
                arguments(
                        TopNLType.TOP250NL, "/topnl/top250nl_relief.gml", 0, 1, "top250nl relief"),
                arguments(
                        TopNLType.TOP250NL,
                        "/topnl/top250nl_spoorbaandeel.gml",
                        0,
                        1,
                        "top250nl spoorbaandeel"),
                arguments(
                        TopNLType.TOP250NL,
                        "/topnl/top250nl_terrein.gml",
                        0,
                        1,
                        "top250nl terrein"),
                arguments(
                        TopNLType.TOP250NL,
                        "/topnl/top250nl_waterdeel.gml",
                        0,
                        1,
                        "top250nl waterdeel"),
                arguments(
                        TopNLType.TOP250NL,
                        "/topnl/top250nl_wegdeel.gml",
                        0,
                        1,
                        "top250nl wegdeel"),
                arguments(
                        TopNLType.TOP100NL,
                        "/topnl/top100nl_functioneelgebied.gml",
                        0,
                        1,
                        "top100nl functioneelgebied"),
                arguments(
                        TopNLType.TOP100NL, "/topnl/top100nl_gebouw.gml", 0, 1, "top100nl gebouw"),
                arguments(
                        TopNLType.TOP100NL, "/topnl/top100nl_hoogte.gml", 0, 1, "top100nl hoogte"),
                arguments(
                        TopNLType.TOP100NL,
                        "/topnl/top100nl_inrichtingselement.gml",
                        0,
                        1,
                        "top100nl inrichtingselement"),
                arguments(
                        TopNLType.TOP100NL,
                        "/topnl/top100nl_registratiefgebied.gml",
                        0,
                        1,
                        "top100nl registratiefgebied"),
                arguments(
                        TopNLType.TOP100NL, "/topnl/top100nl_relief.gml", 0, 1, "top100nl relief"),
                arguments(
                        TopNLType.TOP100NL,
                        "/topnl/top100nl_spoorbaandeel.gml",
                        0,
                        1,
                        "top100nl spoorbaandeel"),
                arguments(
                        TopNLType.TOP100NL,
                        "/topnl/top100nl_terrein.gml",
                        0,
                        1,
                        "top100nl terrein"),
                arguments(
                        TopNLType.TOP100NL,
                        "/topnl/top100nl_waterdeel.gml",
                        0,
                        1,
                        "top100nl waterdeel"),
                arguments(
                        TopNLType.TOP100NL,
                        "/topnl/top100nl_wegdeel.gml",
                        0,
                        1,
                        "top100nl wegdeel"),
                arguments(
                        TopNLType.TOP50NL,
                        "/topnl/top50nl_functioneelgebied.gml",
                        0,
                        1,
                ...
                arguments(
                        TopNLType.TOP50NL,
                        "/topnl/top50nl_inrichtingselement.gml",
                        0,
                        1,
                        "top50nl inrichtingselement"),
                arguments(
                        TopNLType.TOP50NL,
                        "/topnl/top50nl_registratiefgebied.gml",
                        0,
                        1,
                ...
                arguments(
                        TopNLType.TOP50NL,
                        "/topnl/top50nl_spoorbaandeel.gml",
                        0,
                        1,
                ...
                arguments(
                        TopNLType.TOP10NL,
                        "/topnl/top10nl_functioneelgebied.gml",
                        0,
                        1,
                ...
                arguments(
                        TopNLType.TOP10NL,
                        "/topnl/top10nl_geografischgebied.gml",
                        0,
                        1,
                ...
                arguments(
                        TopNLType.TOP10NL,
                        "/topnl/top10nl_inrichtingselement.gml",
                        0,
                        1,
                ...
                arguments(
                        TopNLType.TOP10NL,
                        "/topnl/top10nl_plantopografie.gml",
                        0,
                        1,
                        "top10nl plantopografie"),
                arguments(
                        TopNLType.TOP10NL,
                        "/topnl/top10nl_registratiefgebied.gml",
                        0,
                        1,
                ...
                arguments(
                        TopNLType.TOP10NL,
                        "/topnl/top10nl_spoorbaandeel.gml",
                        0,
                        1,
                ...
                arguments(
                        TopNLType.TOP10NL,
                        "/topnl/top10nl_waterdeel.gml",
                        0,
                        1,
                        "top10nl waterdeel"),
                arguments(
                        TopNLType.TOP10NL, "/topnl/top10nl_wegdeel.gml", 0, 1, "top10nl wegdeel"));
    }
    ...
    public void setUp() throws Exception {
        ...
        if (this.isOracle) {
            ...
            topnl =
                    new DatabaseConnection(
                            OracleConnectionUnwrapper.unwrap(dsTopnl.getConnection()),
                            params.getProperty("topnl.user").toUpperCase());
            topnl.getConfig()
                    .setProperty(
                            DatabaseConfig.PROPERTY_DATATYPE_FACTORY,
                            new Oracle10DataTypeFactory());
        ...
        assumeTrue(
                0L == brmo.getCountBerichten(null, "STAGING_OK"), "Er zijn STAGING_OK berichten");
        assumeTrue(
                0L == brmo.getCountLaadProcessen(null, "STAGING_OK"),
    ...
    public void loadTopNLInStaging(
            TopNLType bestandType,
            String bestandNaam,
        ...
        // assumeNotNull
        assertNotNull(
                TopNLIntegrationTest.class.getResource(bestandNaam),
                "Het test bestand moet er zijn.");

        brmo.loadFromFile(
                bestandType.getType(),
                TopNLIntegrationTest.class.getResource(bestandNaam).getFile(),
                null);
        ...
        assertEquals(
                aantalProcessen,
                processen.size(),
                () -> "Het aantal processen is niet als verwacht voor " + bestandNaam);
    ...
    public void processTopNL(
        ...
        for (TopNLType type : TopNLType.values()) {
            ids.addAll(
                    Arrays.asList(
                            brmo.getLaadProcessenIds(
                                    "bestand_datum", "ASC", type.getType(), "STAGING_OK")));
        }
        ...
        Thread t =
                brmo.toRsgb(
                        RsgbProxy.BerichtSelectMode.BY_LAADPROCES,
                        lpIds,
        ...
        t.join();
        assertEquals(
                LaadProces.STATUS.RSGB_TOPNL_OK.toString(),
                staging.createDataSet().getTable("laadproces").getValue(0, "status"),
                "Alles OK");
    }
}
