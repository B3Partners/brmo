...
<xsl:stylesheet version="1.0"
                ...
                xmlns:KenmerkInOnderzoek="www.kadaster.nl/schemas/lvbag/imbag/kenmerkinonderzoek/v20180601"
                xmlns:selecties-extract="http://www.kadaster.nl/schemas/lvbag/extract-selecties/v20180601"
    ...
    <xsl:template match="sl-bag-extract:bagInfo">
        <!-- ignore -->
    </xsl:template>
    <xsl:template match="sl:standBestand/sl:dataset">
        <!-- ignore -->
    </xsl:template>
    <xsl:template match="sl:standBestand/sl:inhoud">
        <!-- ignore -->
    </xsl:template>
    ...
    <xsl:template match="Objecten:Pand">
        ...
        <pand column-dat-beg-geldh="dat_beg_geldh" column-datum-einde-geldh="datum_einde_geldh">
            ...
            <datum_einde_geldh>
                <xsl:value-of select="Objecten:voorkomen/Historie:Voorkomen/tijdvakgeldigheid/Historie:eindGeldigheid"/>
            </datum_einde_geldh>
            <indic_geconstateerd>
    ...
    <xsl:template match="Objecten:Standplaats">
        ...
        <xsl:variable name="begindate">
            <xsl:value-of select="Objecten:voorkomen/Historie:Voorkomen/tijdvakgeldigheid/Historie:beginGeldigheid"/>
        </xsl:variable>
