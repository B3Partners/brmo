                ...
                <xsl:if test="$key !=''">
                    ...
                    <xsl:choose>
                        ...
                        <xsl:when test="local-name(*[1]) = 'buitenlandseVennootschap'">
                            <xsl:variable name="class">NIET-NATUURLIJK PERSOON</xsl:variable>
                            ...
                            <subject>
                                ...
                                <naam>
                                    <xsl:choose>
                                        <xsl:when test="cat:buitenlandseVennootschap/cat:volledigeNaam"><xsl:value-of select="cat:buitenlandseVennootschap/cat:volledigeNaam" /></xsl:when>
                                        <xsl:otherwise><xsl:value-of select="cat:naam" /></xsl:otherwise>
                                    </xsl:choose>
                                </naam>
                        ...
                        <xsl:when test="local-name(*[1]) = 'samenwerkingsverband'">
                            <xsl:variable name="class">INGESCHREVEN NIET-NATUURLIJK PERSOON</xsl:variable>
                            <!--TODO de afzondelijke rechtspersonen en bedrijven zouden ook nog uitgesplitst kunnen worden -->
                            <subject>
                                <identif><xsl:value-of select="$key" /></identif>
                                <clazz><xsl:value-of select="$class" /></clazz>
                                <typering><xsl:value-of select="substring($class,1,35)" /></typering>
                                <naam>
                                    <xsl:choose>
                                        <xsl:when test="cat:samenwerkingsverband/cat:volledigeNaam"><xsl:value-of select="cat:samenwerkingsverband/cat:volledigeNaam" /></xsl:when>
                                        <xsl:otherwise><xsl:value-of select="cat:naam" /></xsl:otherwise>
                                    </xsl:choose>
                                </naam>
                                <xsl:for-each select="cat:manifesteertZichAls/cat:onderneming/cat:kvkNummer">
                            ...
                            <ingeschr_niet_nat_prs>
                                ...
                                <fk_8aoa_identif>
                                    <xsl:choose>
                                        <xsl:when test="cat:samenwerkingsverband/cat:bezoekLocatie/cat:adres/cat:binnenlandsAdres/cat:bagId/cat:identificatieAdresseerbaarObject">
                                            <xsl:value-of select="cat:samenwerkingsverband/cat:bezoekLocatie/cat:adres/cat:binnenlandsAdres/cat:bagId/cat:identificatieAdresseerbaarObject" />
                                        </xsl:when>
                                        <xsl:when test="cat:samenwerkingsverband/cat:bezoekLocatiePersoon/cat:adres/cat:binnenlandsAdres/cat:bagId/cat:identificatieAdresseerbaarObject">
                                            <xsl:value-of select="cat:samenwerkingsverband/cat:bezoekLocatiePersoon/cat:adres/cat:binnenlandsAdres/cat:bagId/cat:identificatieAdresseerbaarObject" />
                                        </xsl:when>
                                        <xsl:otherwise>
                                            <xsl:value-of select="cat:bezoekLocatie/cat:adres/cat:binnenlandsAdres/cat:bagId/cat:identificatieAdresseerbaarObject" />
                                        </xsl:otherwise>
                                ...
                                <rechtsvorm>
                                    <xsl:if test="cat:samenwerkingsverband/cat:persoonRechtsvorm"><xsl:value-of select="cat:samenwerkingsverband/cat:persoonRechtsvorm"/></xsl:if>
                                    <xsl:if test="cat:persoonRechtsvorm"><xsl:value-of select="cat:persoonRechtsvorm"/></xsl:if>
                                </rechtsvorm>
                                <publiekrechtelijke_rechtsvorm><xsl:value-of select="cat:publiekrechtelijkeRechtsvorm/cat:omschrijving"/></publiekrechtelijke_rechtsvorm>
                                <rsin><xsl:value-of select="cat:samenwerkingsverband/cat:rsin"/></rsin>
                            </ingeschr_niet_nat_prs>
