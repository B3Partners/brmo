...
public class DatabaseTest extends TestUtil {
  ...
  public void testSaveHoogte(TopNLType type) throws Exception {
    ...
    ResultSetHandler<Hoogte> h =
        new BeanHandler<>(
            Hoogte.class,
            new BasicRowProcessor(new DbUtilsGeometryColumnConverter(instance.getGjc())));

    Hoogte real =
        run.query(
            "SELECT * FROM " + type.getType() + ".hoogte WHERE identificatie=?", h, identificatie);
  ...
  public void testSaveGebouw(TopNLType type)
    ...
    Gebouw real =
        run.query(
            "SELECT * FROM " + type.getType() + ".gebouw WHERE identificatie=?", h, identificatie);
    assertNotNull(real, "Insert failed");
    testStandardTopNLEntity(real, e);
  ...
  public void testSavePlaats(TopNLType type)
    ...
    Plaats real =
        run.query(
            "SELECT * FROM " + type.getType() + ".plaats WHERE identificatie=?", h, identificatie);
    assertNotNull(real, "Insert failed");
    testStandardTopNLEntity(real, e);
  ...
  public void testSaveRelief(TopNLType type)
    ...
    Relief real =
        run.query(
            "SELECT * FROM " + type.getType() + ".relief WHERE identificatie=?", h, identificatie);
    assertNotNull(real, "Insert failed");
    testStandardTopNLEntity(real, e);
  ...
  public void testSaveTerrein(TopNLType type)
    ...
    Terrein real =
        run.query(
            "SELECT * FROM " + type.getType() + ".terrein WHERE identificatie=?", h, identificatie);
    assertNotNull(real, "Insert failed");
    testStandardTopNLEntity(real, e);
  ...
  public void testSaveWegdeel(TopNLType type)
    ...
    Wegdeel real =
        run.query(
            "SELECT * FROM " + type.getType() + ".wegdeel WHERE identificatie=?", h, identificatie);
    assertNotNull(real, "Insert failed");
    testStandardTopNLEntity(real, e);
