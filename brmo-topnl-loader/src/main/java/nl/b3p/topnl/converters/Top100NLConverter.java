...
import nl.b3p.topnl.top100nl.FysiekVoorkomenWegT100Type;
import nl.b3p.topnl.top100nl.GebouwType;
import nl.b3p.topnl.top100nl.GeografischGebiedType;
import nl.b3p.topnl.top100nl.HoogteType;
import nl.b3p.topnl.top100nl.InrichtingselementType;
import nl.b3p.topnl.top100nl.JaNeeType;
import nl.b3p.topnl.top100nl.RegistratiefGebiedType;
import nl.b3p.topnl.top100nl.ReliefType;
import nl.b3p.topnl.top100nl.SpoorbaandeelType;
import nl.b3p.topnl.top100nl.TerreinType;
import nl.b3p.topnl.top100nl.Top100NlObjectType;
import nl.b3p.topnl.top100nl.Top100NlObjectType.Identificatie;
...
public class Top100NLConverter extends Converter {
  ...
  protected static final Log log = LogFactory.getLog(Top100NLConverter.class);
  ...
  public TopNLEntity convertObject(Object featureMember)
    ...
    log.debug(
        "Converted type " + entity.getClass() + ", identificatie: " + entity.getIdentificatie());
  ...
  public Hoogte convertHoogte(Object jaxbObject)
    ...
    convertTop100NlObjectType(h, hoogte);
  ...
  private void convertTop100NlObjectType(Top100NlObjectType type, TopNLEntity entity) {
  ...
  public FunctioneelGebied convertFunctioneelGebied(Object jaxbObject)
    ...
    convertTop100NlObjectType(f, fg);
  ...
  public Gebouw convertGebouw(Object jaxbObject)
    ...
    convertTop100NlObjectType(g, gb);
    String types = "";
    for (TypeGebouwT100Type typeGebouwT100Type : g.getTypeGebouw()) {
      if (types.length() != 0) {
        types += ",";
      }
  ...
  public Inrichtingselement convertInrichtingselement(Object jaxbObject)
    ...
    convertTop100NlObjectType(i, ie);

    ie.setGeometrie(gc.convertGeometry(i.getGeometrie()));

    ie.setTypeInrichtingselement(
        i.getTypeInrichtingsElement() != null ? i.getTypeInrichtingsElement().value() : null);
  ...
  public RegistratiefGebied convertRegistratiefGebied(Object jaxbObject)
    ...
    convertTop100NlObjectType(r, rg);
    ...
    rg.setTypeRegistratiefGebied(
        r.getTypeRegistratiefGebied() != null ? r.getTypeRegistratiefGebied().value() : null);
    return rg;
  }
  ...
  public Spoorbaandeel convertSpoorbaandeel(Object jaxbObject)
    ...
    String fysieks = "";
    for (FysiekVoorkomenSpoorT100Type fk : r.getFysiekVoorkomen()) {
      if (fysieks.length() != 0) {
        fysieks += ",";
      }
      fysieks += fk.value();
  ...
  public Waterdeel convertWaterdeel(Object jaxbObject)
    ...
    String fysieks = "";
    for (FysiekVoorkomenWaterT100Type fk : r.getFysiekVoorkomen()) {
      if (fysieks.length() != 0) {
        fysieks += ",";
      }
      fysieks += fk.value();
  ...
  public Wegdeel convertWegdeel(Object jaxbObject)
    ...
    String fysieks = "";
    for (FysiekVoorkomenWegT100Type fk : r.getFysiekVoorkomen()) {
      if (fysieks.length() != 0) {
        fysieks += ",";
      }
      fysieks += fk.value();
    ...
    rg.setTypeInfrastructuur(
        r.getTypeInfrastructuur() != null ? r.getTypeInfrastructuur().value() : null);
    rg.setTypeWeg(r.getTypeWeg() != null ? r.getTypeWeg().value() : null);
    rg.setVerhardingstype(r.getTypeVerharding().value());
    rg.setHoofdverkeersgebruik(
        r.getHoofdverkeersgebruik() != null ? r.getHoofdverkeersgebruik().value() : null);
