...
@XmlType(
    ...
    propOrder = {"typeFunctioneelGebied", "naamNL", "naamFries", "geometrie"})
public class FunctioneelGebiedType extends Top100NlObjectType {
   ...
   *
   * @return possible object is {@link TypeFunctioneelGebiedT100Type }
   */
   ...
   *
   * @param value allowed object is {@link TypeFunctioneelGebiedT100Type }
   */
