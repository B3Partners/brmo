...
/**
 * A property that has a curve as its value domain may either be an appropriate geometry element
...
@XmlType(
        ...
        propOrder = {"abstractCurve"})
public class CurvePropertyType {

    @XmlElement(name = "AbstractCurve")
    protected AbstractCurveType abstractCurve;
     ...
     *
     * @return possible object is {@link AbstractCurveType }
     */
     ...
     *
     * @param value allowed object is {@link AbstractCurveType }
     */
    public void setAbstractCurve(AbstractCurveType value) {
