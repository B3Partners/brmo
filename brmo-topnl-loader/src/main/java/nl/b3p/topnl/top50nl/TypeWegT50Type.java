...
public enum TypeWegT50Type {
  ...
  /**
   * Verharde weg die is aangeduid met een E-nummer, maar niet met een A-nummer, of verharde weg die
   * onderdeel is van een verbindingsroute tussen grotere plaatsen, wat blijkt uit blauwe
  ...
  /**
   * Verharde weg die een verbinding vormt tussen bewoonde oorden, tussen wijken binnen een dorp of
   * stad, en daartoe bewegwijzerd zijn met blauwe ANWB-borden of lokale borden
   */
