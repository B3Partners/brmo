...
public enum TypeWegT50Type {
    ...
    /**
     * Afgebakende taxibaan op een vliegveld (rolbaan) / Terrein voor geparkeerd staande vliegtuigen
     * (platform)
     */
    ...
    /**
     * Weg met gescheiden rijbanen en ongelijkvloerse kruisingen, daartoe aangeduid met het
    ...
    /**
     * Verharde weg die is aangeduid met een E-nummer, maar niet met een A-nummer, of verharde weg
     * die onderdeel is van een verbindingsroute tussen grotere plaatsen, wat blijkt uit blauwe
     * ANWB-borden, dan wel onderdeel is van een route om eindigende A of E-routes tot een gesloten
     * netwerk te completeren
     */
    @XmlEnumValue("hoofdweg")
    HOOFDWEG("hoofdweg"),

    /**
     * Verharde weg die een verbinding vormt tussen bewoonde oorden, tussen wijken binnen een dorp
     * of stad, en daartoe bewegwijzerd zijn met blauwe ANWB-borden of lokale borden
     */
