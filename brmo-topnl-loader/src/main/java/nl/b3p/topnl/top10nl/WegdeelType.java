...
public class WegdeelType extends Top10NlObjectType {
    ...
    @XmlAnyElement protected Element[] hartGeometrie;
    @XmlAnyElement protected Element hoofdGeometrie;
     ...
     * why there is not a <CODE>set</CODE> method for the typeWeg property.
     *
     ...
     * <p>This accessor method returns a reference to the live list, not a snapshot. Therefore any
     * modification you make to the returned list will be present inside the JAXB object. This is
     * why there is not a <CODE>set</CODE> method for the hoofdverkeersgebruik property.
     *
     * <p>For example, to add a new item, do as follows:
     *
     * <pre>
     ...
     * <p>This accessor method returns a reference to the live list, not a snapshot. Therefore any
     * modification you make to the returned list will be present inside the JAXB object. This is
     * why there is not a <CODE>set</CODE> method for the naam property.
     *
     * <p>For example, to add a new item, do as follows:
     *
     * <pre>
