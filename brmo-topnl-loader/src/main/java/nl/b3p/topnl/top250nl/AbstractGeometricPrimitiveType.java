 ...
 * geometric primitive is a geometric object that is not decomposed further into other primitives in
 * the system. All primitives are oriented in the direction implied by the sequence of their
 * coordinate tuples.
 *
...
@XmlSeeAlso({PointType.class, AbstractSurfaceType.class, AbstractCurveType.class})
