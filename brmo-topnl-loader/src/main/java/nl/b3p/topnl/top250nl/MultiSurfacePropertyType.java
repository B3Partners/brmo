...
/**
 * A property that has a collection of surfaces as its value domain may either be an appropriate
 ...
 * document). Either the reference or the contained element shall be given, but neither both nor
 * none.
 *
