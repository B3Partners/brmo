...
@XmlType(name = "WaterdeelType", namespace = "http://register.geostandaarden.nl/gmlapplicatieschema/top250nl/1.2.0", propOrder = {
    "typeWater",
    "breedteklasse",
    "fysiekVoorkomen",
    "voorkomen",
    ...
    extends Top250NlObjectType
{
    ...
    @XmlElement(required = true)
    protected BRTVlakOfLijnPropertyType geometrie;
     ...
     * @return
     *     possible object is
     *     {@link BRTVlakOfLijnPropertyType }
     *     
     */
    public BRTVlakOfLijnPropertyType getGeometrie() {
        return geometrie;
    }
     ...
     *     
     */
    public void setGeometrie(BRTVlakOfLijnPropertyType value) {
