...
@XmlType(name = "FunctioneelGebiedType", namespace = "http://register.geostandaarden.nl/gmlapplicatieschema/top250nl/1.2.0", propOrder = {
    ...
    extends Top250NlObjectType
{
    ...
    @XmlElement(required = true)
    protected BRTVlakMultivlakOfPuntPropertyType geometrie;
     ...
     * @return
     *     possible object is
     *     {@link BRTVlakMultivlakOfPuntPropertyType }
     *     
     */
    public BRTVlakMultivlakOfPuntPropertyType getGeometrie() {
        return geometrie;
    }
     ...
     *     
     */
    public void setGeometrie(BRTVlakMultivlakOfPuntPropertyType value) {
