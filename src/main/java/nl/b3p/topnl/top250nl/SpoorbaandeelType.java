...
@XmlType(name = "SpoorbaandeelType", namespace = "http://register.geostandaarden.nl/gmlapplicatieschema/top250nl/1.2.0", propOrder = {
    "typeInfrastructuur",
    "typeSpoorbaan",
    "fysiekVoorkomen",
    "spoorbreedte",
    ...
    extends Top250NlObjectType
{
    ...
    @XmlElement(required = true)
    protected CurvePropertyType geometrie;
     ...
     *     
     */
    public CurvePropertyType getGeometrie() {
        return geometrie;
    }
     ...
     *     
     */
    public void setGeometrie(CurvePropertyType value) {
