...
@XmlType(name = "RegistratiefGebiedType", namespace = "http://register.geostandaarden.nl/gmlapplicatieschema/top250nl/1.2.0", propOrder = {
    ...
    extends Top250NlObjectType
{
    ...
    @XmlElement(required = true)
    protected BRTVlakOfMultivlakPropertyType geometrie;
     ...
     * @return
     *     possible object is
     *     {@link BRTVlakOfMultivlakPropertyType }
     *     
     */
    public BRTVlakOfMultivlakPropertyType getGeometrie() {
        return geometrie;
    }
     ...
     *     
     */
    public void setGeometrie(BRTVlakOfMultivlakPropertyType value) {
