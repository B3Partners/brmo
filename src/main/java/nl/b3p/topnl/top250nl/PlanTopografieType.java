...
@XmlType(name = "PlanTopografieType", namespace = "http://register.geostandaarden.nl/gmlapplicatieschema/top250nl/1.2.0", propOrder = {
    "typeObject",
    "naam",
    "geometrie"
})
    ...
    extends Top250NlObjectType
{
    ...
    @XmlElement(required = true)
    protected BRTVlakLijnOfPuntPropertyType geometrie;
     ...
     * @return
     *     possible object is
     *     {@link BRTVlakLijnOfPuntPropertyType }
     *     
     */
    public BRTVlakLijnOfPuntPropertyType getGeometrie() {
        return geometrie;
    }
     ...
     *     
     */
    public void setGeometrie(BRTVlakLijnOfPuntPropertyType value) {
