...
@XmlType(name = "InrichtingselementType", namespace = "http://register.geostandaarden.nl/gmlapplicatieschema/top250nl/1.2.0", propOrder = {
    ...
    extends Top250NlObjectType
{
    ...
    @XmlElement(required = true)
    protected BRTLijnOfPuntPropertyType geometrie;
     ...
     * @return
     *     possible object is
     *     {@link BRTLijnOfPuntPropertyType }
     *     
     */
    public BRTLijnOfPuntPropertyType getGeometrie() {
        return geometrie;
    }
     ...
     *     
     */
    public void setGeometrie(BRTLijnOfPuntPropertyType value) {
