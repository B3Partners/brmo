...
public class TOP250NLParser {
    ...
    public TOP250NLParser() throws JAXBException {
        String schemaLocation = TOP250NLParser.class.getResource("standaardGML/XSD-Resolver/finalized/top250nl_resolved.xsd").toString();
        Configuration configuration = new ApplicationSchemaConfiguration("http://register.geostandaarden.nl/gmlapplicatieschema/top250nl/1.2.0", schemaLocation);
    ...
    public List<String> getTypeNames() throws IOException {
        ...
        URL schemaLocation = TOP250NLParser.class.getResource("XSD-Resolver/finalized/top250nl_resolved.xsd");
        ...
        SimpleFeatureType featureType = gml.decodeSimpleFeatureType(schemaLocation, new NameImpl(
                "http://register.geostandaarden.nl/gmlapplicatieschema/top250nl/1.2.0", "FunctioneelGebied"));
    ...
    public SimpleFeatureCollection parseFeatures(InputStream in) throws IOException, SAXException, ParserConfigurationException {
      ...
      //create the parser with the gml 3.0 configuration
        ...
        org.geotools.xml.Parser p = new org.geotools.xml.Parser( configuration );
//parse
        SimpleFeatureCollection fc = (SimpleFeatureCollection) p.parse( in );
        return fc;
    }
