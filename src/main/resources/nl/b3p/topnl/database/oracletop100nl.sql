...
BEFORE INSERT ON top100nl.Hoogte 
FOR EACH ROW
...
BEFORE INSERT ON top100nl.FunctioneelGebied 
FOR EACH ROW
...
BEFORE INSERT ON top100nl.Gebouw 
FOR EACH ROW
...
BEFORE INSERT ON top100nl.GeografischGebied 
FOR EACH ROW
...
BEFORE INSERT ON top100nl.Inrichtingselement 
FOR EACH ROW
...
BEFORE INSERT ON top100nl.Plaats 
FOR EACH ROW
...
BEFORE INSERT ON top100nl.RegistratiefGebied 
FOR EACH ROW
...
BEFORE INSERT ON top100nl.Relief 
FOR EACH ROW
...
BEFORE INSERT ON top100nl.Spoorbaandeel 
FOR EACH ROW
...
BEFORE INSERT ON top100nl.Terrein 
FOR EACH ROW
...
BEFORE INSERT ON top100nl.Waterdeel 
FOR EACH ROW
...
BEFORE INSERT ON top100nl.Wegdeel 
FOR EACH ROW
...
BEFORE INSERT ON top100nl.PlanTopografie 
FOR EACH ROW
