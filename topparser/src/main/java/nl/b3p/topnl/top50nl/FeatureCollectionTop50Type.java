...
@XmlType(name = "FeatureCollectionTop50Type", namespace = "http://register.geostandaarden.nl/gmlapplicatieschema/top50nl/1.1.1", propOrder = {
    "featureMember"
})
    ...
    extends AbstractGMLType
{
    ...
    protected List<FeatureCollectionTop50Type.FeatureMember> featureMember;
     ...
     * {@link FeatureCollectionTop50Type.FeatureMember }
     * 
     * 
     */
    public List<FeatureCollectionTop50Type.FeatureMember> getFeatureMember() {
        if (featureMember == null) {
            featureMember = new ArrayList<FeatureCollectionTop50Type.FeatureMember>();
        }
