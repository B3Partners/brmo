...
<table>
    ...
    <tr><td>Dataset:</td><td><stripes:text name="config['dataset']" disabled="true"/></td></tr>
    <tr><td>Format:</td><td><stripes:text name="config['format']" disabled="true"/></td></tr>

    <tr><td>BGT excludedtypes:</td><td><stripes:text name="bgtExludedTypes" size="80"/></td></tr>
    <tr><td>BGT geographischFilter:</td><td><stripes:text name="bgtGeographischFilter" size="80"/></td></tr>

    <tr><td>Start deltaId:</td><td><stripes:text name="bgtGeographischFilter" size="40"/><br>(laat leeg om te beginnen met laatste volledige stand)</td></tr>
