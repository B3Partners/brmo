...
<stripes:layout-render name="/WEB-INF/jsp/layout/default.jsp">
    <stripes:layout-component name="title">
        <c:choose>
            <c:when test="${actionBean.complete}">
                Klaar - Directoryscan uitvoeren
            </c:when>
            <c:otherwise>
                [<fmt:formatNumber maxFractionDigits="1" value="${actionBean.progress}"/>%] Bezig met uitvoeren directoryscan...
            </c:otherwise>
        </c:choose>
    ...
    <stripes:layout-component name="contents">
        <h1>Directory scannen voor berichten</h1>
        <p>
