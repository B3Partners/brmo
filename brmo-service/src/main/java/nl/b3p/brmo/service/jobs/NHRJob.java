...
public class NHRJob implements Job {
    ...
    public void execute(JobExecutionContext context) throws JobExecutionException {
        ...
        try {
            ...
            secondsBetweenFetches =
                    (Integer) ctx.lookup("java:comp/env/brmo/nhr/secondsBetweenFetches");
        } catch (Exception e) {
        ...
        while (true) {
            ...
            for (NHRInschrijving process : procList) {
                ...
                try {
                    ...
                    log.info(
                            String.format("KVK nummer %s ophalen mislukt", process.getKvkNummer()),
                            e);
                    exception = e;
                ...
                totalFetchCount += 1;
                averageFetchTime =
                        (averageFetchTime * 9.0f
                                        + (Calendar.getInstance().getTimeInMillis() - fetchStart))
                                / 10.0f;
            }
