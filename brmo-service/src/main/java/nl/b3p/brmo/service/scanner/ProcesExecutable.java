...
public interface ProcesExecutable extends Runnable {
    ...
    enum ProcessingImple {
        ...
        MaterializedViewRefresh, BerichtstatusRapportProces, TopNLScannerProces, PDOKDownloadServiceProces, BGTMutatieServiceDeltaProces, BGTMutatieServiceStandProces;
    }
