...
public class PostgresCopyEscapeUtilsTest {
    /**
     * This class is used as a parametrized test parameter and displays the value escaped for Java
     * so non-whitespace characters are legible.
     */
    ...
    private static Stream<Arguments> escape() {
        return Stream.of(
                ...
                .map(
                        arguments ->
                                Arguments.of(
                                        new EscapedForDisplayParam(arguments[0]), arguments[1]));
    }
}
