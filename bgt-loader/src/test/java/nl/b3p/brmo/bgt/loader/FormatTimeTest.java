...
class FormatTimeTest {
  ...
  void hours() {
    ...
    assertEquals(
        "5h 32m  4s", Utils.formatDuration(Duration.ofHours(5).plusMinutes(32).plusSeconds(4)));
  }
  ...
  void days() {
    ...
    assertEquals(
        "5d 2m 12s", Utils.formatDuration(Duration.ofDays(5).plusMinutes(2).plusSeconds(12)));
    assertEquals(
        "5d 3h  2m 12s",
        Utils.formatDuration(Duration.ofDays(5).plusHours(3).plusMinutes(2).plusSeconds(12)));
  }
}
