...
public class BooleanAttributeColumnMapping extends AttributeColumnMapping {
  ...
  // Do not override toQueryParameter() to set boolean parameter as a Boolean object but as string,
  // so for Oracle 'true' or 'false' for a varchar2 column is set. For PostgreSQL this will still
  // use a boolean column, accepting a string parameter.
}
