...
public class PostgresCopyEscapeUtils {
  /**
   * Escapes column values for use in the text-based PostgreSQL COPY format with the default column
   * and row delimiters, see <a
  ...
  public static final CharSequenceTranslator ESCAPE =
      new CharSequenceTranslator() {
        @Override
        public int translate(CharSequence charSequence, int start, Writer writer)
            throws IOException {
