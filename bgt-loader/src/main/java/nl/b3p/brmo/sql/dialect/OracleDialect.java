...
public class OracleDialect implements SQLDialect {
    ...
    /**
     * Override because the default implementation using Connection.getMetaData().getTables() is very slow on Oracle.
     */
    @Override
    public boolean tableExists(Connection c, String name) throws SQLException {
        return new QueryRunner().query(c, "select 1 from user_objects where object_type = 'TABLE' and object_name = ?", new ScalarHandler<Integer>(), name.toUpperCase())
                != null;
    }
}
