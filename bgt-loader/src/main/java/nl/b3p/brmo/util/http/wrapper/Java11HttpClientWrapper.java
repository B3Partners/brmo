...
/**
 * Wraps the Java 11 {@link java.net.http.HttpClient}. Follows redirects by default but sets the
 * HTTP version to 1.1 instead of HTTP/2 if the {@code httpclientwrapper.java11.http1_1} system
 * property is set.
 *
...
public class Java11HttpClientWrapper
    ...
    @Override
    public HttpResponseWrapper request(URI uri, String... requestHeaders)
