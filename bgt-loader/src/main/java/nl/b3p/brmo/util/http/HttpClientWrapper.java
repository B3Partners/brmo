...
public interface HttpClientWrapper<REQUEST, RESPONSE> {
     ...
     *
     * @param uri The URI.
     * @param requestHeaders The request headers to send. The supplied String instances must
     *     alternate as header names and header values. Only single request header values are
     *     expected.
