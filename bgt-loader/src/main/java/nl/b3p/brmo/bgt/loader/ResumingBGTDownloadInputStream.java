...
public class ResumingBGTDownloadInputStream extends ResumingInputStream {
    ...
    public ResumingBGTDownloadInputStream(
            URI uri, BGTObjectTableWriter writer, boolean logRetries) {
        super(
                new HttpStartRangeInputStreamProvider(
                        ...
                        new Java11HttpClientWrapper() {
                            ...
                            @Override
                            public HttpResponseWrapper wrapResponse(
                        ...
                        if (causeForRetry != null && logRetries) {
                            String msg =
                                    getMessageFormattedString(
                                            ...
                                            totalRetries,
                                            position,
                                            ExceptionUtils.getRootCause(causeForRetry)
                                                    .getMessage());
